...
/** Proxy genérico para el módulo de privacidad (AvisoPrivacidad) — adjunta el JWT de la cookie httpOnly. */
async function proxy(request: NextRequest, params: { path: string[] }) {
  ...
  const url = `${API_URL}/privacidad/${ruta}${request.nextUrl.search}`;
