...
import { usarEstadoConexion } from "../../../../lib/offline/estado-conexion";
import {
 ...
 */
export function usarCapturaOffline(inspeccionId: string) {
  const estadoConexion = usarEstadoConexion();
