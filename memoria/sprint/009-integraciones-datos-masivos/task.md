...
> **✅ HU-3 RETOMADA E IMPLEMENTADA el 2026-07-24**: las precondiciones de arriba ya se cumplían (portal de 006 implementado el 2026-07-23; 005 retomado desde el 2026-07-21). Todas las tareas marcadas `[ ]`/`[~]` "Pospuesto" abajo quedaron implementadas, con algunas desviaciones reales de diseño respecto al plan original de esta página (ej. SHA-256 en vez de bcrypt para `claveHash`, sin restricción por empresa en el lookup del código de verificación). Este `task.md` se conserva como documento histórico del plan original — el estado real y las desviaciones están en `checklist.md` e `impl.md` (sección "Desviaciones reales encontradas durante la implementación de HU-3").
